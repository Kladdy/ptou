...
date: '2025-12-15'
lastmod: '2025-12-15'
tags: ['tal', 'matematik', 'talförmåga']
draft: true
summary: 'Vad är talförmåga? Är det förmågan att tala? Eller någonting helt annat? I det här blogginlägget går vi genom ett tal som går igenom alla möjliga tal som Topi en dag vill förklara för sin son.' # TODO
images: ['/static/images/posts/dishwasher-eco-mode/magnus_sees_dishwasher.png'] # TODO
authors: ['topi']
---
...
och så vidare tills oändlighet. För mitt öga verkar det som en skön regel: alla jämna tal slutar med _-bbelt_ och alla udda tal slutar med _-ppelt_. Man vet omedelbart från uttalet om talet är delbart med två eller inte. Fast det skulle inte hjälpa mig som Sigge retade mig i avsnitt [två av PTOU](https://rss.com/podcasts/ptou/2290129/). Men för er svenskarna skulle det vara ju jätteanvändbart! Jag lämnar detta här, alla svenskarna kan gärna börja tillämpa det :)
