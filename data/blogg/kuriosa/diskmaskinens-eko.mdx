...
![Magnus ser en diskmaskin](/static/images/posts/dishwasher-eco-mode/magnus_sees_dishwasher.png)
...
> [!Note/Notera]
> Nedan kommer lite bakgrund i hur man räknar fram effekt och energi, och vilka enheter de oftast ges i. Vill du hoppa över detta, antingen för att du inte gillar matte - eller för att du gillar matte alldeles för mycket, så kan du gå direkt till [datan](#okej-nog-med-teori-jag-vill-se-data).
